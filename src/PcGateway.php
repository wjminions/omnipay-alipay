 ...
 */
class PcGateway extends AbstractGateway
{
    ...
    {
        return $this->createRequest('\Omnipay\Alipay\Message\PcPurchaseRequest', $parameters);
    }


    public function completePurchase(array $parameters = array ())
    {
        return $this->createRequest('\Omnipay\Alipay\Message\PcCompletePurchaseRequest', $parameters);
    }

    public function query(array $parameters = array())
    {
        return $this->createRequest('\Omnipay\Alipay\Message\PcQueryRequest', $parameters);
    }


    public function refund(array $parameters = array())
    {
        return $this->createRequest('\Omnipay\Alipay\Message\PcRefundRequest', $parameters);
    }


    public function completeRefund(array $parameters = array())
    {
        return $this->createRequest('\Omnipay\Alipay\Message\PcCompleteRefundRequest', $parameters);
    }
}
