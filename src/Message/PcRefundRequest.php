...
/**
 * Class PcRefundRequest
 *
 * @package Omnipay\Alipay\Message
 */
class PcRefundRequest extends AbstractAppRequest
{
    ...
    public function sendData($data)
    {
        ...
        return $this->response = new PcRefundResponse($this, array_merge($data, (array)$result->$responseNode));
    }
}
