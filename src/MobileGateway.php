...
class MobileGateway extends AbstractGateway
{
    ...
    {
        return $this->createRequest('\Omnipay\Alipay\Message\MobilePurchaseRequest', $parameters);
    }


    public function completePurchase(array $parameters = array ())
    {
        return $this->createRequest('\Omnipay\Alipay\Message\MobileCompletePurchaseRequest', $parameters);
    }

    public function query(array $parameters = array())
    {
        return $this->createRequest('\Omnipay\Alipay\Message\MobileQueryRequest', $parameters);
    }


    public function refund(array $parameters = array())
    {
        return $this->createRequest('\Omnipay\Alipay\Message\MobileRefundRequest', $parameters);
    }


    public function completeRefund(array $parameters = array())
    {
        return $this->createRequest('\Omnipay\Alipay\Message\MobileCompleteRefundRequest', $parameters);
    }
}
